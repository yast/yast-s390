...
module Yast
  class DasdClient < Client
    def main
      ...
      Builtins.y2milestone("DASD module started")
      ...
      @cmdline_description = {
        ...
        "help"       => _(
          "Configuration of DASD"
        ),
        "guihandler" => fun_ref(method(:DASDSequence), "symbol ()"),
        "initialize" => fun_ref(DASDController.method(:Read), "boolean ()"),
        "finish"     => fun_ref(DASDController.method(:Write), "boolean ()"),
        "actions" =>
      ...
      Builtins.y2milestone("DASD module finished")
      Builtins.y2milestone("----------------------------------------")
