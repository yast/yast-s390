    ...
    def initialize_s390_iucvterminal_server_helps(include_target)
      ...
      @HELP = {
        ...
        "ts"       => _(
          ...
          _(
            "<p>TS-Shell allows to specify <b>Authorization</b> for every TS-Shell user and group. The rights of a group are inherited by its members.</p>"
          ) +
          # TS-Shell dialog help 2/5
          _(
            "<p>Each allowed z/VM ID can be selected manually under <b>Selection</b>, defined by a <b>Regex</b> or loaded from a <b>File</b> which contains all allowed z/VM IDs separated by line breaks.</p>"
          ) +
        ...
        "ts-user"  => _(
          ...
          _(
            "<p>To ensure that the user changes his password after the first login, activate <b>Force Password Change</b>.</p>"
          ) +
